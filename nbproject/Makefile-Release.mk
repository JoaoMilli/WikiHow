...
${OBJECTDIR}/Contribuicao.o: Contribuicao.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Contribuicao.o Contribuicao.c
...
${OBJECTDIR}/Link.o: Link.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Link.o Link.c
...
${OBJECTDIR}/ListaLink.o: ListaLink.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ListaLink.o ListaLink.c
